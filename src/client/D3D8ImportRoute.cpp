...
namespace bfvr
{
D3D8ImportRouteResult RouteExecutableDirect3DCreate8(
    D3D8CreateFunction replacement) noexcept
{
    D3D8ImportRouteResult result = {};
    ...
    for (; descriptor->Name != 0; ++descriptor)
    {
        ...
        if (_stricmp(moduleName, "d3d8.dll") != 0 ||
        ...
        for (; names->u1.AddressOfData != 0; ++names, ++functions)
        {
            ...
            result.previous =
                reinterpret_cast<D3D8CreateFunction>(*importAddress);
